...
I’ll leave you to figure out GET, POST, and DELETE, but will lend you a helpful tip on PUT: you are PUT-ing like a POST, but instead of POST-ing, you are re-PUT-ing information in place of which you are POST-ing or double PUT-ing.  
